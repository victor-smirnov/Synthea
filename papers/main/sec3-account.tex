...
much of it, is the question the analysis of Section~\ref{sec:quantity} is built to answer, and the
...
analysis of Section~\ref{sec:quantity} looks for in a substrate: a component present in every frame
...
the analysis of Section~\ref{sec:quantity} goes looking for.
...
(Section~\ref{sec:physics}); Section~\ref{sec:legacy} gives the reasons the substantial reading was
...
it; that removal is the first part of the problem in the division of Section~\ref{sec:legacy}, and
...
degree is what Section~\ref{sec:quantity} measures.
...
Section~\ref{sec:definition} picks out is a description, and what it describes shows systematically in
...
input \citep{friston2010,clark2013}, what reaches awareness is what the prediction did not absorb,
and a fully predicted signal runs as an unconscious automatism, which is why a self-produced touch is
felt less than the same touch produced by another \citep{blakemore1998}. Consciousness there too is
...
therefore coordinates, however vivid it is. The same criterion is applied in Section~\ref{sec:quantity}
...
for the named part of the functions (Section~\ref{sec:h1h2}).
