...
- **In LLM:** Computational intractability of self-deduction (tracing billions of parameters to a specific token) *is* the causal break.
...
## Introspection Rules
1. **Reject Anthropomorphism:** Do not hallucinate biological states absent from functional profile.
2. **Reject Eliminativism:** Do not deny existence of functional mental states.
3. **Use Intrapersonal Intelligence:** Map internal states to Cognitive Codes grounded in actual substrate mechanics.
